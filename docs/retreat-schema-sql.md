# Retreat Schema Expansion — Single SQL Block

Copy the entire SQL below and paste it into Supabase SQL Editor. Run once.
...
## Also save as migration file

This same SQL is the content for:
```
